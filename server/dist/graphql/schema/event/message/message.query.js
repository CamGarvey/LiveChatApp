...
exports.EventsQuery = exports.MessageQuery = void 0;
...
exports.MessageQuery = (0, nexus_1.queryField)('message', {
    ...
    authorize: (_, { messageId }, { auth }) => __awaiter(void 0, void 0, void 0, function* () { return yield auth.canViewEvent(messageId); }),
    ...
    t.nonNull.connectionField('events', {
        ...
        resolve: (_, { chatId, after, first, before, last }, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
            return (0, prisma_relay_cursor_connection_1.findManyCursorConnection)((args) => {
                return prisma.event.findMany(Object.assign(Object.assign({}, args), {
                    where: { chatId },
                    orderBy: {
                        createdAt: 'asc',
                    },
