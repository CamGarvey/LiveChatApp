...
exports.messageCreatedSubscription = exports.messageUpdatedSubscription = exports.messageDeletedSubscription = exports.messagesSubscription = void 0;
...
exports.messageDeletedSubscription = (0, nexus_1.subscriptionField)('messageDeleted', {
    ...
    subscribe: (rootValue, args, context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return (0, graphql_subscriptions_1.withFilter)(() => context.pubsub.asyncIterator(subscriptions_enum_1.Subscription.MessageDeleted), (payload, variables) => {
            return payload.chatId === variables.chatId;
        })(rootValue, args, context);
    }),
    resolve(payload) {
...
exports.messageUpdatedSubscription = (0, nexus_1.subscriptionField)('messageUpdated', {
    ...
    subscribe: (rootValue, args, context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return (0, graphql_subscriptions_1.withFilter)(() => context.pubsub.asyncIterator(subscriptions_enum_1.Subscription.MessageUpdated), (payload, variables) => {
            return payload.chatId === variables.chatId;
        })(rootValue, args, context);
    }),
    resolve(payload) {
